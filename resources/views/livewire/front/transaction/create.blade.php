            ...
            <form wire:submit.prevent="store" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="date" id="purchase_date" wire:model="purchase_date"
                        class="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white placeholder-gray-400 focus:ring-2 focus:ring-red-500 focus:outline-none">
                    @error('purchase_date') 
                ...
                <div class="flex justify-end space-x-2 pt-2">
                    <button type="button" wire:click="closeModal"
                        class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm transition cursor-pointer">
                        Batal
                    </button>
                    <button type="submit"
