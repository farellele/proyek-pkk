    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="bg-white text-gray-800 rounded-2xl shadow-lg p-6 w-full max-w-md space-y-4">
            ...
            <form wire:submit.prevent="store" class="space-y-4">
                ...
                {{-- Pilih Game --}}
                <div>
                    <label for="gameId" class="block mb-1 text-sm font-medium text-gray-700">Pilih Game</label>
                    <select id="gameId" wire:model="gameId"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-800 bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none">
